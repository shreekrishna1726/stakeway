...
$(document).ready(function() {
	...
	$('#searchbox input[name=\'search\']').parent().find('button').on('click', function() {
		...
		var value = $('header #searchbox input[name=\'search\']').val();
	...
	$('#searchbox input[name=\'search\']').on('keydown', function(e) {
		if (e.keyCode == 13) {
			$('header #searchbox input[name=\'search\']').parent().find('button').trigger('click');
		}
	});
			...
			success: function(json) {
				...
				if (json['success']) {
					...
					$('#cart > ul').load('index.php?route=common/cart/info ul li');
						$('#cart > button').html('<div class="cart_image"><span id="cart-total"> ' + json['total'] + '</span>' + '</div>');
				}
			}
		});
	},
